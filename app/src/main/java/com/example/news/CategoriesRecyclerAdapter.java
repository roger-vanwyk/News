...
//        Passes layout file for displaying the card item
        return new CategoriesRecyclerAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.categories_recycler_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull CategoriesRecyclerAdapter.ViewHolder holder, int position) {
